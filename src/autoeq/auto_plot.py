...
from spinorama.filters.peq import peq_spl, peq_preamp_gain
from spinorama.compute.misc import savitzky_golay, compute_statistics
...
def graph_results(
    ...
    g_spin_noeq, g_spin_noeq_di, _, _ = plot_spinorama_traces(
        unmelted_spin, g_params, {}, False, DEFAULT_FREQ_RANGE
    )
    ...
    if spin_auto is not None:
        ...
        g_spin_auto, g_spin_auto_di, _, _ = plot_spinorama_traces(
            unmelted_spin_auto, g_params, {}, False, DEFAULT_FREQ_RANGE
        )
