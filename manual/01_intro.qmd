...
- **Tonality**: this is a value between -10 and 10. It is defined in the [CEA2034 standard](https://webstore.ansi.org/standards/cea/cea20342015ansi) and is computed from the spinorama data: Higher is better.
...
- **Flatness**: This is the variation in dB around the average SPL of the on axis measurement between 300Hz and 3kHz. Lower is better.
